...
@Component({
  selector: 'app-notes-list-desktop',
  templateUrl: './notes-list-desktop.component.html',
  styleUrls: ['./notes-list-desktop.component.scss']
})
export class NotesListDesktopComponent implements OnInit {
  ...
  copyNoteLink(noteData) {
    (navigator as any).clipboard.writeText(`${window.location.hostname}/${noteData.subject}/${noteData.id}`)
      .then(() => {
